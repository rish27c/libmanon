...
#This is not a real encrptor but one I made using dictionary, it doesn't really provide actual security and can be reverse-engineered or broken easily unlike real encryption
d_en={
